    ...
    return (
        <div className="max-w-screen-xl mx-auto py-6 flex items-center justify-between border-b-[1px] border-zinc-700">
            <div className="nleft flex items-center">
                <div className="font-regular text-sm flex items-center gap-1 cursor-pointer">
                <a href="#" className="font-regular text-sm flex items-center gap-1 cursor-pointer"> Kenesis </a>
                </div>
                {/* <img
